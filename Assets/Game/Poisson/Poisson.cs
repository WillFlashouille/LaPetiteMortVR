...
public class Poisson : MonoBehaviour, OnNotifyBehaviour{
	...
	private IEnumerator WaitForSpeechEnd(){
		...
		while (Vector3.Angle (Vector3.forward, Game.reticle.transform.worldToLocalMatrix.MultiplyPoint (this.transform.position)) > 40f) {
			yield return null;
		}
